...
export const MOCK_ATTENDANCE: AttendanceRecord[] = [
  { studentId: 1, lessonId: 102, status: 'A', reason: 'Поважна причина' },
  { studentId: 2, lessonId: 102, status: 'A', reason: 'Поважна причина', comment: 'Виїзд з родиною' },
  { studentId: 3, lessonId: 101, status: 'S', reason: 'Хворий' },
  { studentId: 5, lessonId: 101, status: 'A', reason: 'Без причини' },
  { studentId: 5, lessonId: 102, status: 'A', reason: 'Без причини' },
  { studentId: 5, lessonId: 103, status: 'A', reason: 'Без причини' },
  { studentId: 5, lessonId: 104, status: 'A', reason: 'Без причини' },
  { studentId: 5, lessonId: 105, status: 'A', reason: 'Без причини' },
  { studentId: 5, lessonId: 106, status: 'A', reason: 'Без причини' },
  { studentId: 7, lessonId: 104, status: 'E', reason: 'Поважна причина' },
  { studentId: 8, lessonId: 201, status: 'S', reason: 'Хворий' },
  { studentId: 9, lessonId: 202, status: 'E', reason: 'Поважна причина' },
];

export const MOCK_STUDENT_MEALS: StudentMeal[] = [
  { studentId: 1, date: '2026-08-11', hadMeal: false },
  { studentId: 3, date: '2026-08-14', hadMeal: false },
  { studentId: 6, date: '2026-08-12', hadMeal: false },
  { studentId: 8, date: '2026-08-13', hadMeal: false },
];

export const MOCK_ATTENDANCE_REPORT_DAYS: AttendanceReportDay[] = [
  { date: '2026-08-03', className: '8-А', fullyAbsentStudents: 1, fullyAbsentStudentIds: [5], partiallyAbsentStudents: 2, partiallyAbsentStudentIds: [1, 2], lessonsWithAbsences: 3 },
  { date: '2026-08-04', className: '8-А', fullyAbsentStudents: 0, fullyAbsentStudentIds: [], partiallyAbsentStudents: 1, partiallyAbsentStudentIds: [4], lessonsWithAbsences: 2 },
  { date: '2026-08-05', className: '8-А', fullyAbsentStudents: 1, fullyAbsentStudentIds: [3], partiallyAbsentStudents: 2, partiallyAbsentStudentIds: [1, 7], lessonsWithAbsences: 4 },
  { date: '2026-08-06', className: '8-А', fullyAbsentStudents: 0, fullyAbsentStudentIds: [], partiallyAbsentStudents: 3, partiallyAbsentStudentIds: [2, 3, 6], lessonsWithAbsences: 3 },
  { date: '2026-08-07', className: '8-А', fullyAbsentStudents: 1, fullyAbsentStudentIds: [5], partiallyAbsentStudents: 1, partiallyAbsentStudentIds: [2], lessonsWithAbsences: 4 },
  { date: '2026-08-10', className: '8-А', fullyAbsentStudents: 0, fullyAbsentStudentIds: [], partiallyAbsentStudents: 2, partiallyAbsentStudentIds: [1, 6], lessonsWithAbsences: 3 },
  { date: '2026-08-11', className: '8-А', fullyAbsentStudents: 0, fullyAbsentStudentIds: [], partiallyAbsentStudents: 1, partiallyAbsentStudentIds: [7], lessonsWithAbsences: 2 },
  { date: '2026-08-12', className: '8-А', fullyAbsentStudents: 2, fullyAbsentStudentIds: [2, 5], partiallyAbsentStudents: 1, partiallyAbsentStudentIds: [1], lessonsWithAbsences: 5 },
  { date: '2026-08-13', className: '8-А', fullyAbsentStudents: 1, fullyAbsentStudentIds: [1], partiallyAbsentStudents: 2, partiallyAbsentStudentIds: [3, 7], lessonsWithAbsences: 4 },
  { date: '2026-08-14', className: '8-А', fullyAbsentStudents: 1, fullyAbsentStudentIds: [5], partiallyAbsentStudents: 3, partiallyAbsentStudentIds: [1, 2, 7], lessonsWithAbsences: 4 },
  { date: '2026-08-03', className: '8-Б', fullyAbsentStudents: 0, fullyAbsentStudentIds: [], partiallyAbsentStudents: 1, partiallyAbsentStudentIds: [8], lessonsWithAbsences: 1 },
  { date: '2026-08-04', className: '8-Б', fullyAbsentStudents: 1, fullyAbsentStudentIds: [8], partiallyAbsentStudents: 0, partiallyAbsentStudentIds: [], lessonsWithAbsences: 2 },
  { date: '2026-08-05', className: '8-Б', fullyAbsentStudents: 0, fullyAbsentStudentIds: [], partiallyAbsentStudents: 2, partiallyAbsentStudentIds: [8, 9], lessonsWithAbsences: 2 },
  { date: '2026-08-06', className: '8-Б', fullyAbsentStudents: 0, fullyAbsentStudentIds: [], partiallyAbsentStudents: 1, partiallyAbsentStudentIds: [9], lessonsWithAbsences: 2 },
  { date: '2026-08-07', className: '8-Б', fullyAbsentStudents: 1, fullyAbsentStudentIds: [9], partiallyAbsentStudents: 1, partiallyAbsentStudentIds: [8], lessonsWithAbsences: 3 },
  { date: '2026-08-10', className: '8-Б', fullyAbsentStudents: 0, fullyAbsentStudentIds: [], partiallyAbsentStudents: 1, partiallyAbsentStudentIds: [8], lessonsWithAbsences: 1 },
  { date: '2026-08-11', className: '8-Б', fullyAbsentStudents: 0, fullyAbsentStudentIds: [], partiallyAbsentStudents: 2, partiallyAbsentStudentIds: [8, 9], lessonsWithAbsences: 2 },
  { date: '2026-08-12', className: '8-Б', fullyAbsentStudents: 1, fullyAbsentStudentIds: [8], partiallyAbsentStudents: 1, partiallyAbsentStudentIds: [9], lessonsWithAbsences: 3 },
  { date: '2026-08-13', className: '8-Б', fullyAbsentStudents: 0, fullyAbsentStudentIds: [], partiallyAbsentStudents: 1, partiallyAbsentStudentIds: [8], lessonsWithAbsences: 1 },
  { date: '2026-08-14', className: '8-Б', fullyAbsentStudents: 0, fullyAbsentStudentIds: [], partiallyAbsentStudents: 2, partiallyAbsentStudentIds: [8, 9], lessonsWithAbsences: 2 },
];
...
export const MOCK_ATTENDANCE_REASONS: AttendanceReason[] = [
  { id: 1, code: 'Н', name: 'Без причини', isActive: true },
  { id: 2, code: 'п/п', name: 'Поважна причина', isActive: true },
  { id: 3, code: 'хв', name: 'Хворий', isActive: true },
];
